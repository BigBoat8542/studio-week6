...
At the end of this tutorial you will have a working map that shows malnutrition and health sites in Mali. You will submit a link to your working map, including an explanation of any changes you make, or changes that could/should be made in the `narrative` section of the web page, hosted in a Github pages site.
...
## Next Steps
Congratulations, you've built an interactive map that can be used to identify health sites in Mali! What could you do to improve this map? I would love to see you improve this map, but this is *not* required. Some ideas might be to create buttons to only show certain health sites ([this tutorial would be a good starting point for that](http://duspviz.mit.edu/web-map-workshop/leaflet-javascript-interactions/)) or using [panel layers](https://labs.easyblog.it/maps/leaflet-panel-layers/) to add functionality to your legend, change the icons, or add other forms of interactivity. If you do make changes, please briefly explain them in the narrative section of the web page. If you do *not* make any changes, you do need to brifly explain what changes could be made to improve the map. Include 250-300 words At the end of this tutorial you will have a working map that shows malnutrition and health sites in Mali. You will submit a link to your working map, including an explanation of any changes you make, or changes that could/should be made in the `narrative` section of the web page.
